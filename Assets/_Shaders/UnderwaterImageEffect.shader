Shader "HUnderwater Driving 2/UnderwaterImageEffect"
{
    Properties
    {
		...
		_PixelOffset("Fixel Offset", float) = 0.005
		...
		SubShader
		{
            ...
            fixed4 frag (v2f i) : COLOR
            {
				...
				float4 noiseToDirection = float4(cos(noise*3.141592653897932384626433832795 * 2),sin(noise*3.141592653897932384626433832795 *2), 0, 0);   //cos(noise*M_PI * 2), sin(noise*M_PI * 2)
